...
var product2 = [
    {
        ...
        summary1: "双重回收站，7天真实删除延迟机制，确保数据经过反复确认后删除",
        summary2: "安全水印，防止泄漏截图，数据加密，防止后台进去，支持分享密码、过期时间",
        summary3: "硬件支持防盗锁，软件支持硬盘级数据加密，硬盘丢失后，用户也无法解开",
        summary4: "全平台操作日志，用户从登录开始，任何操作都有日志记载，可根据日期，用户，时间进行筛选，导出",
    ...
    },
    {
        ...
        summary1: "共享文件支持多级管理授权，权限下放，部门管理员，群组管理员等管理角色",
        summary2: "文件夹授权一共支持14种权限",
        summary3: "支持AD域、钉钉、企业微信、Oauth、Cas等用户登录方式",
        summary4: "支持存储状态，云盘服务器状态，磁盘状态，系统负载，过载报警等"
    ...
    },
    {
        ...
        typeName3: "知识审批",
        typeName4: "共享排行榜",
        summary1: "企业知识、经验的传承。岗位技能需求、经验的汇聚、便于员工交接。常见与客户沟通的技巧、经典案例的解决方案",
        summary2: "自定义多级标签，针对一个知识点，进行多方位搜索。",
        summary3: "针对知识库设定管理员，专家（审批），推送审批消息，审批入库",
        summary4: "根据用户的浏览，下载，贡献，自动计算排行榜",
        summary: "全平台支持上传、下载、查看文件。"
    ...
    },
    {
        ...
        summary1: "系统根据存储的空间的状态，系统进行，进行预警。",
        summary2: "后台可视化管理，空间预警，系统存储状态一目了然，帮您定时统计云盘实际真实使用状态",
        summary3: "任意部门文件夹可配置空间额度，批量修改已经分配的个人云盘容量",
        summary4: "分布式文件系统，支持数据加密，海量扩展，定时同步备份。"
    ...
    },
    {
        ...
        summary1: "自带钉钉集成套件",
        summary2: "基于企业微信定制套件",
        summary3: "支持企业自定义皮肤UI",
        summary4: "开放API，支持与企业其他系统集成接入"
